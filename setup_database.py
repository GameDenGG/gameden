...
POSTGRES_SQL = [
    ...
    """,
    """
    CREATE TABLE IF NOT EXISTS game_discovery_feed (
        id BIGSERIAL PRIMARY KEY,
        ...
        latest_price DOUBLE PRECISION NULL,
        latest_original_price DOUBLE PRECISION NULL,
        latest_discount_percent INTEGER NULL,
        historical_low DOUBLE PRECISION NULL,
        historical_status TEXT NULL,
        historical_low_hit BOOLEAN NOT NULL DEFAULT FALSE,
        buy_recommendation TEXT NULL,
        buy_reason TEXT NULL,
        deal_score DOUBLE PRECISION NULL,
        buy_score DOUBLE PRECISION NOT NULL DEFAULT 0,
        worth_buying_score DOUBLE PRECISION NOT NULL DEFAULT 0,
        momentum_score DOUBLE PRECISION NOT NULL DEFAULT 0,
        trending_score DOUBLE PRECISION NOT NULL DEFAULT 0,
        deal_opportunity_score DOUBLE PRECISION NOT NULL DEFAULT 0,
        deal_opportunity_reason TEXT NULL,
        predicted_next_sale_price DOUBLE PRECISION NULL,
        predicted_next_discount_percent INTEGER NULL,
        predicted_next_sale_window_days_min INTEGER NULL,
        predicted_next_sale_window_days_max INTEGER NULL,
        predicted_sale_confidence TEXT NULL,
        predicted_sale_reason TEXT NULL,
        popularity_score DOUBLE PRECISION NOT NULL DEFAULT 0,
        price_vs_low_ratio DOUBLE PRECISION NULL,
        max_discount INTEGER NULL,
        current_players INTEGER NULL,
        player_growth_ratio DOUBLE PRECISION NULL,
        short_term_player_trend DOUBLE PRECISION NULL,
        review_score INTEGER NULL,
        review_score_label TEXT NULL,
        review_count INTEGER NULL,
        genres TEXT NULL,
        tags TEXT NULL,
        platforms TEXT NULL,
        worth_buying_reason_summary TEXT NULL,
        trend_reason_summary TEXT NULL,
        deal_heat_reason TEXT NULL,
        is_released INTEGER NOT NULL DEFAULT 1,
        is_upcoming BOOLEAN NOT NULL DEFAULT FALSE,
        release_date DATE NULL,
        is_strong_buy BOOLEAN NOT NULL DEFAULT FALSE,
        is_wait_pick BOOLEAN NOT NULL DEFAULT FALSE,
        is_new_historical_low BOOLEAN NOT NULL DEFAULT FALSE,
        is_big_discount BOOLEAN NOT NULL DEFAULT FALSE,
        is_trending_now BOOLEAN NOT NULL DEFAULT FALSE,
        updated_at TIMESTAMPTZ NOT NULL DEFAULT now()
    );
    """,
...
SQLITE_SQL = [
    ...
    CREATE TABLE IF NOT EXISTS game_discovery_feed (
        ...
        latest_original_price REAL NULL,
        latest_discount_percent INTEGER NULL,
        historical_low REAL NULL,
        historical_status TEXT NULL,
        historical_low_hit INTEGER NOT NULL DEFAULT 0,
        buy_recommendation TEXT NULL,
        buy_reason TEXT NULL,
        deal_score REAL NULL,
        buy_score REAL NOT NULL DEFAULT 0,
        worth_buying_score REAL NOT NULL DEFAULT 0,
        momentum_score REAL NOT NULL DEFAULT 0,
        trending_score REAL NOT NULL DEFAULT 0,
        deal_opportunity_score REAL NOT NULL DEFAULT 0,
        deal_opportunity_reason TEXT NULL,
        predicted_next_sale_price REAL NULL,
        predicted_next_discount_percent INTEGER NULL,
        predicted_next_sale_window_days_min INTEGER NULL,
        predicted_next_sale_window_days_max INTEGER NULL,
        predicted_sale_confidence TEXT NULL,
        ...
        price_vs_low_ratio REAL NULL,
        max_discount INTEGER NULL,
        current_players INTEGER NULL,
        player_growth_ratio REAL NULL,
        short_term_player_trend REAL NULL,
        review_score INTEGER NULL,
        review_score_label TEXT NULL,
        review_count INTEGER NULL,
        genres TEXT NULL,
        ...
        release_date DATE NULL,
        is_strong_buy INTEGER NOT NULL DEFAULT 0,
        is_wait_pick INTEGER NOT NULL DEFAULT 0,
        is_new_historical_low INTEGER NOT NULL DEFAULT 0,
        is_big_discount INTEGER NOT NULL DEFAULT 0,
        is_trending_now INTEGER NOT NULL DEFAULT 0,
        updated_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP
    );
    """,
    ...
    "ALTER TABLE game_snapshots ADD COLUMN deal_opportunity_score REAL DEFAULT 0;",
    "ALTER TABLE game_snapshots ADD COLUMN deal_opportunity_reason TEXT;",
